        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPurchasePrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    MaxPurchasePrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Unit = table.Column<int>(type: "integer", nullable: false),
                    CurrentAveragePrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    SafetyDocumentURL = table.Column<string>(type: "text", nullable: true),
                    FoodSafetyCertificateId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DispatchDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPriceAtTimeOfOrder = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
